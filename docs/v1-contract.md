...
| 6   | `login`              | Email + password, show-password, links to register / forgot password                         | `features/auth/login`                                | todo   |
...
| 10  | `topup`                     | Enter credit amount                                               | `features/auth/top-up-dialog`                                        | todo   |
| 11  | `register`                  | First/last name, email, password (min 8)                          | `features/auth/register-dialog`                                      | todo   |
| 12  | `forget-password`           | Two-step: request 4-digit code by email, then code + new password | `features/auth/forgot-password-dialog`                               | todo   |
